...
\* ================================================================================================================= */
	 ...
	 */
	@Test(expected = NullPointerException.class)
	@Ignore("The set launches NullPointerException only if the passed object is null")
	 ...
	 */
	@Test(expected = NullPointerException.class)
	@Ignore("The set contains entries with null values")
	...
	@Ignore("Contains returns false for non-entries, it should launch ClassCastException")
	 ...
	 */
	@Test(expected = NullPointerException.class)
	@Ignore("Same thing as testContainsNullValueOnEmptyEntrySet")
	 ...
	 */
	@Test(expected = ClassCastException.class)
	@Ignore("Remove returns false for non-entries, it shouldn't launch ClassCastException")
	 ...
	 */
	@Test(expected = ClassCastException.class)
	@Ignore("ContainsAll returns false for non-entries, it shouldn't launch ClassCastException")
	 ...
	 */
	@Test
	@Ignore("Since we are talking about sets, set should not be aware of the type of sets it is comparing with, so it should return false"+
			" only if the other set is not a set at all or contains different items, not if it is a different type of set")
	 ...
	 */
	@Test
	@Ignore("Il metodo toString() ritorna la stringa nel formato {key=value}, quindi non è possibile testare una vista vuota")
